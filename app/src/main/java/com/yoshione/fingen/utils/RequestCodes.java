...
public class RequestCodes {
    ...
    public static final int REQUEST_CODE_BULK_SELECT_MODEL = 5;
    public static final int REQUEST_CODE_OPEN_PREFERENCES   = 11;
    public static final int REQUEST_CODE_OPEN_PRO  = 13;
    public static final int REQUEST_CODE_SIGN_IN  = 16;
